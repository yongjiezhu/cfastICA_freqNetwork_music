...
%% 
%---Modified version from fourierica.m. Just delete the STFT procedure. So
%---do STFT analysis befor using this function.
%--- by Yongjie.10/1/2017
...
function varargout = cfastICA(origdata,varargin)
...
switch nargout
    ...
    case 4, varargout={S_FT,A_orig,W_orig,iter};
